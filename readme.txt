...
- **Customizable Shortcodes:** Use the `[ire_building]` shortcode to embed your interactive maps and customize them with your specific data.
...
To create an interactive building, use the `[ire_building]` shortcode. You can customize the building map by uploading images and adding interactive hotspots through the plugin's settings page.
