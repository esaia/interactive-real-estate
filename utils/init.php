...
function ire_enqueue_scripts($hook)
{
    ...
    // wp_enqueue_script('ire-vue-scripts', plugin_dir_url(IRE_PLUGIN_FILE) . 'dist/assets/index.js', array(), null, true);
    // wp_enqueue_script('ire-vue-scripts', 'http://localhost:8080/js/app.js', array(), null, true);
